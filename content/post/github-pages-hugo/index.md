...
Позже разберу, как запилить своего тг бота, чтобы можно было писать посты. Ведь ограничение у такого метода - надо после каждых правок закидывать статьи в git руками.
